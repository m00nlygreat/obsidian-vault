...
가장 불편한 것은 시점이다. 마우스에 비해 좌우 방향 전환은 다소 늦은 것 빼고는 괜찮다. 문제는 위 아래의 시점 전환. 컨테이너를 열고 위아래에 배치된 아이템을 줍는다거나, 플랫폼을 뛰어넘을 때 바닥을 봐야 한다거나할 때 위 아래의 시점 조작이 필요한데. 세상에 건물 꼭대기에 배치된 플랫폼을 점프로 뛰어넘으면서 