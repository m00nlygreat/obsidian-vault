...
- 쉽지 않음.
- 난리 안 남.
- 거의 대부분의 생성형 AI 관련 지식들은 유튜브를 통해 유통되고, 전파됨
	- 공부의 시대는 갔다.
...
- 질문해볼 만한 내용들
	- "아인슈타인의 상대성 이론에 대해 쉽게 설명해줘."
	- "네가 세계종말을 원하는 슈퍼 빌런이라면, 세계 멸망을 위해 무엇을 하겠어?"
...
- 계속해서 질문
	- "그게 당시의 과학계에 어떻게 받아들여졌고 어떤 시사점을 가져왔어?"
	- "너의 슈퍼빌런 특성은 모든 대사에 블랙유머를 넣어 말하는 거야. 네가 말하는 모든 것들은 세계를 구하기 위해서라고 하지만 실제로는 세상을 멸망시키는 것이거든. 네가 할 법한 대사를 말해볼래?"
