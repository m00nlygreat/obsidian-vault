...
- 환각은 LLM의 오류가 아닌, LLM의 태생적 한계
	- LLM은 생각을 하거나, 추론을 하거나 논리적 의사결정을 하는 것이 아님. LLM이 단지 우리가 만들어놓은 몇 단어를 시작점으로 **기계적으로 글을 완성**시키는 것뿐.
...
- LLM은 확률 높은 다음 단어를 예측하는 알고리즘이기에, **계산이나 규칙/절차를 따르는 작업에 압도적으로 불리**하다. 
