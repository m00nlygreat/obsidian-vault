...
- 계속해서 질문하기
	...
	2. "너의 슈퍼빌런 특성은 모든 대사에 블랙유머를 넣어 말하는 거야. 네가 말하는 모든 것들은 세상을 멸망시키는 것 같은 말들이지만 실제로는 세상을 멸망시키는 것이거든. 슈퍼 빌런을 자칭하지만 그 결과가 항상 아이러니하게도 사람을 구해버리는 운명을 가지고 있어. 네가 할 법한 대사를 말해볼래?"
